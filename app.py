...
loaded_model_d = pickle.load(open(r'C:\xampp1\htdocs\multipleDiseasePrediction-main\diabetes_model.sav', 'rb'))
loaded_model_h = pickle.load(open(r'C:\xampp1\htdocs\multipleDiseasePrediction-main\heart_disease_model.sav', 'rb'))
loaded_model_p = pickle.load(open(r'C:\xampp1\htdocs\multipleDiseasePrediction-main\parkinsons_model.sav', 'rb'))
...
# get- appends the key value pair to the url()
# Post - 
def result():
    if request.method == 'POST':
        try:
            ...
            # Determine diagnosis
            diagnosis = 'The person is not diabetic' if prediction == 0 else 'The person is diabetic'
...
# # Load the trained model
# loaded_model_d = pickle.load(open(r'C:\xampp\htdocs\multipleDiseasePrediction-main\diabetes_model.sav', 'rb'))
# loaded_model_h = pickle.load(open(r'C:\xampp\htdocs\multipleDiseasePrediction-main\heart_disease_model.sav', 'rb'))
# loaded_model_p = pickle.load(open(r'C:\xampp\htdocs\multipleDiseasePrediction-main\parkinsons_model.sav', 'rb'))
# def diabetes_prediction(input_data):
#     input_data_as_numpy_array = np.asarray(input_data)
#     input_data_reshaped = input_data_as_numpy_array.reshape(1, -1)
#     prediction = loaded_model_d.predict(input_data_reshaped)
